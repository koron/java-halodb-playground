...
public class BenchmarkTool {
    ...
    private final static int numberOfRecords = 10_000_000;

    private static volatile boolean isReadComplete = false;

    private static final int numberOfReads = 20_000_000;
    private static final int numberOfReadThreads = 8;
    private static final int noOfReadsPerThread = numberOfReads / numberOfReadThreads;
